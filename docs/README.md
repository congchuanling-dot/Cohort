...
| `[部分完成]` | [computer_control_roadmap.md](computer_control_roadmap.md) | “操控电脑的所有操作”的能力缺口、风险边界和开发顺序；`cohert doctor computer` 基础版已完成，下一步补 `computer_scroll/drag/clipboard`。 |
