...
| `[部分完成]` | [evidence_driven_multi_agent_delivery.md](evidence_driven_multi_agent_delivery.md) | 契约/DAG、隔离子进程 Builder、Git worktree、Scheduler、lease 和 Artifact Board 已落地；Evidence、Integration、Verifier、定向返修和事务合并继续实现。 |
