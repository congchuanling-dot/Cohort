...
| `[部分完成]` | [evidence_driven_multi_agent_delivery.md](evidence_driven_multi_agent_delivery.md) | 契约/DAG、隔离 Builder、Scheduler、Artifact、Evidence 新鲜度、Integration Worktree 和确定性 Gate 已落地；Verifier、定向返修和事务合并继续实现。 |
