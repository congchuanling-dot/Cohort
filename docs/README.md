...
| `[部分完成]` | [computer_control_roadmap.md](computer_control_roadmap.md) | “操控电脑的所有操作”的能力缺口、风险边界和开发顺序；`cohert doctor computer`、P1 核心原语、`computer_visual_snapshot` OCR/vision 基础版与 `computer_execute_step` 单步 OAV 已完成。 |
