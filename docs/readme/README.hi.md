...
अगर `browser_not_connected` मिले, तो local extension directory देखने के लिए `cohort extension path` चलाएं, या `chrome://extensions` खोलकर load करने के लिए `cohort extension open` चलाएं।
