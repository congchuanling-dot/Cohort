...
| 13 | Agent Eval 与可视化 | `[完成第一版]` | 已提供 `eval init/list/run/history/report`、core/tool-routing 内置 suite、多维确定性断言、隔离 session、并发执行、自动基线比较、JSON/Markdown/HTML Dashboard；judge 模型评分和 A/B matrix 待补。 |
