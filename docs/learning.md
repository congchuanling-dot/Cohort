...
- 桌面端 M1 + M2.3：`desktop_permissions`、`desktop_windows`、`desktop_activate`、`desktop_screenshot`、`desktop_ax_snapshot`、`desktop_ocr`、`desktop_ax_press`、`desktop_press_key`、`desktop_type_text`
