...
export function QualityOverviewPage() {
  ...
  return <section className="page-stack">
    <header className="page-heading"><div><p className="eyebrow">AGENT QUALITY</p><h2>质量与稳定性</h2><p>评测结果、回归趋势和失败证据统一视图。</p></div><Link className="button-link" to="/quality/stability">稳定性分析</Link></header>
