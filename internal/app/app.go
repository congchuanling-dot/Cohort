...
func newRegistry(workspace string, browserClient browser.Client) *tools.Registry {
	...
	registry.Register(tools.NewDesktopVisualClick(desktopDriver, confirmations, workspace))
	registry.Register(tools.NewDesktopPressKey(desktopDriver, confirmations))
	registry.Register(tools.NewDesktopTypeText(desktopDriver))
