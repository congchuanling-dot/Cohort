...
func BuildSystemPromptForProject(cfg Config, skillStore *skill.Store, projectRoot string) string {
	...
	return buildSystemPromptWithIndex(cfg, skillStore, capabilityIndex, projectPrompt, planPrompt)
}

func buildSystemPromptWithIndex(cfg Config, skillStore *skill.Store, capabilityIndex string, projectPrompt string, planPrompt string) string {
